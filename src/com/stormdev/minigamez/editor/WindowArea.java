...
public class WindowArea extends JFrame implements ActionListener,ChangeListener {
	...
	JPanel optionsPane = new JPanel(new GridLayout(numberOfOptions,1));
	JPanel optionSettingsPane = new JPanel();
	  ...
	  private JPanel optionsPlayerCount = new JPanel(new GridLayout(10,1));
	  ...
	  WindowArea() // the frame constructor method
	  {
	    ...
	    optionsPlayerCount.add(playerCountOptionsTitle);
	    optionsPlayerCount.add(new JLabel("Minimum players:"));
	    optionsPlayerCount.add(minPlayers);
	    optionsPlayerCount.add(savePlayerCount);
	  ...
	  public void actionPerformed(ActionEvent event)
	  {
	    ...
	    {
	    System.out.println("Detected change in player count options");
	      ...
	      try {
			...
			minPlayers.setText("2");
			popUpMsg("Field must be a number!", "ERROR");
		}
	      if(minimum < 1){
	    	  minPlayers.setText("2");
				popUpMsg("Field must be at least 1!", "ERROR");
	      }
	    }
